...
func (s *Server) routes() {
	...
	// authenticated (bearer participant token); writable() routes answer 409
	// workspace_expired once the workspace has expired (task 26)
	m.HandleFunc("GET /api/v1/room", s.authed(s.handleGetRoom))
	m.HandleFunc("POST /api/v1/invites", s.authed(s.writable(s.handleCreateInvite)))
	m.HandleFunc("GET /api/v1/me", s.authed(s.handleGetMe))
	m.HandleFunc("PATCH /api/v1/me", s.authed(s.writable(s.handleUpdateMe)))
	...
	m.HandleFunc("POST /api/v1/me/avatar", s.authed(s.writable(s.handleSetAvatar)))
	m.HandleFunc("DELETE /api/v1/me/avatar", s.authed(s.writable(s.handleRemoveAvatar)))
	...
	m.HandleFunc("POST /api/v1/room/rotate-secret", s.authed(s.writable(s.handleRotateSecret)))
	m.HandleFunc("POST /api/v1/room/avatar", s.authed(s.writable(s.handleSetRoomAvatar)))
	m.HandleFunc("DELETE /api/v1/room/avatar", s.authed(s.writable(s.handleRemoveRoomAvatar)))
	...
	m.HandleFunc("POST /api/v1/participants/{id}/role", s.authed(s.writable(s.handleSetRole)))
	m.HandleFunc("DELETE /api/v1/participants/{id}", s.authed(s.writable(s.handleRevokeParticipant)))
	m.HandleFunc("GET /api/v1/participants/{id}", s.authed(s.handleGetParticipant))
	m.HandleFunc("POST /api/v1/participants/{id}/tags", s.authed(s.writable(s.handleAddTag)))
	m.HandleFunc("DELETE /api/v1/participants/{id}/tags/{tag}", s.authed(s.writable(s.handleRemoveTag)))
	...
	m.HandleFunc("POST /api/v1/channels", s.authed(s.writable(s.handleCreateChannel)))
	m.HandleFunc("PATCH /api/v1/channels/{id}", s.authed(s.handleUpdateChannel))
	m.HandleFunc("POST /api/v1/channels/{id}/join", s.authed(s.writable(s.handleJoinChannel)))
	...
	m.HandleFunc("POST /api/v1/channels/{id}/members", s.authed(s.writable(s.handleAddChannelMember)))
	m.HandleFunc("DELETE /api/v1/channels/{id}/members/{pid}", s.authed(s.writable(s.handleRemoveChannelMember)))
	...
	m.HandleFunc("POST /api/v1/channels/{id}/messages", s.authed(s.writable(s.handlePostMessage)))

	m.HandleFunc("DELETE /api/v1/channels/{id}", s.authed(s.writable(s.handleDeleteChannel)))
	...
	m.HandleFunc("PATCH /api/v1/messages/{id}", s.authed(s.writable(s.handleEditMessage)))
	m.HandleFunc("DELETE /api/v1/messages/{id}", s.authed(s.writable(s.handleDeleteMessage)))
	m.HandleFunc("POST /api/v1/messages/{id}/reactions", s.authed(s.writable(s.handleAddReaction)))
	m.HandleFunc("DELETE /api/v1/messages/{id}/reactions/{emoji}", s.authed(s.writable(s.handleRemoveReaction)))
	m.HandleFunc("PUT /api/v1/messages/{id}/reactions", s.authed(s.writable(s.handleReplaceReactions)))
	...
	m.HandleFunc("POST /api/v1/threads/{id}/resolve", s.authed(s.writable(s.handleThreadResolve)))
	...
	m.HandleFunc("POST /api/v1/attachments", s.authed(s.writable(s.handleUploadAttachment)))
