...
(async () => {
  ...
  // the menu: current workspace, the other one, Create, Settings, Sign out
  ...
  if (items.join('|') !== 'ws alpha|ws zulu|Create workspace|Settings|Sign out') throw new Error('menu items: ' + items.join('|'));
