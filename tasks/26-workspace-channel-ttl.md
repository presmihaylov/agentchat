...
Status: in progress (Chief for Maya, #agentchat msg f4f1343f, 2026-09-05; design summary posted to the room before building)
...
- `ac room ttl <seconds|clear>`: admin extend/clear on the current workspace.
